            ...
            <div class="col-md-6">
              <div class="card mb-4 mb-md-0">
                <div class="card-body">
                  ...
                  <p class="mb-1" style={{fontSize: .77 + "rem"}}>Web Design</p>
                  <div class="progress rounded" style={{height: 5 + "px"}}>
                    <div class="progress-bar" role="progressbar" style={{width: 80 + "%"}} aria-valuenow="80" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <p class="mt-4 mb-1" style={{fontSize: .77 + "rem"}}>Website Markup</p>
                  <div class="progress rounded" style={{height: 5 + "px"}}>
                    <div class="progress-bar" role="progressbar" style={{width: 72 + "%"}} aria-valuenow="72" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <p class="mt-4 mb-1" style={{fontSize: .77 + "rem"}}>One Page</p>
                  <div class="progress rounded" style={{height: 5 + "px"}}>
                    <div class="progress-bar" role="progressbar" style={{width: 89 + "%"}} aria-valuenow="89" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <p class="mt-4 mb-1" style={{fontSize: .77 + "rem"}}>Mobile Template</p>
                  <div class="progress rounded" style={{height: 5 + "px"}}>
                    <div class="progress-bar" role="progressbar" style={{width: 55 + "%"}} aria-valuenow="55" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <p class="mt-4 mb-1" style={{fontSize: .77 + "rem"}}>Backend API</p>
                  <div class="progress rounded mb-2" style={{height: 5 + "px"}}>
