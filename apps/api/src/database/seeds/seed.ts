...
const sampleUsers = [
  ...
  },
  {
    ...
    profile: {
      name: 'Test User',
      bio: {
        en: 'Test user for development',
        vi: 'Người dùng test cho phát triển'
      },
      avatar: '',
      socialLinks: {
        github: '',
...
const sampleTags = [
  {
    ...
    slug: 'design',
    description: {
      en: 'Web design and UI/UX',
      vi: 'Thiết kế web và UI/UX'
    },
    color: '#11d6f0',
    tenantId: 'default'
  },
  {
    ...
    description: {
      ...
      vi: 'Giao diện người dùng và trải nghiệm người dùng'
    },
    color: '#ff6b6b',
    tenantId: 'default'
  },
  {
    ...
    slug: 'react',
    description: {
      en: 'React JavaScript library',
      vi: 'Thư viện JavaScript React'
    },
    color: '#61dafb',
    tenantId: 'default'
  },
  ...
  },
  {
    ...
    description: {
      ...
      vi: 'Ngôn ngữ lập trình JavaScript'
    },
    color: '#f7df1e',
    tenantId: 'default'
  },
  {
    ...
    slug: 'nodejs',
    description: {
      en: 'Node.js runtime environment',
      vi: 'Môi trường runtime Node.js'
    },
    color: '#339933',
    tenantId: 'default'
  },
  {
    ...
    slug: 'animation',
    description: {
      en: 'Web animations and transitions',
      vi: 'Animation và chuyển đổi web'
    },
    color: '#ff6b6b',
    tenantId: 'default'
  },
  {
    ...
    slug: 'fashion',
    description: {
      en: 'Fashion and lifestyle',
      vi: 'Thời trang và lối sống'
    },
    color: '#ff9ff3',
    tenantId: 'default'
  },
  ...
  },
  {
    ...
    slug: 'storytelling',
    description: {
      en: 'Storytelling and content creation',
      vi: 'Kể chuyện và tạo nội dung'
    },
    color: '#5f27cd',
    tenantId: 'default'
  },
  {
    ...
    slug: 'trends',
    description: {
      en: 'Latest trends and innovations',
      vi: 'Xu hướng và đổi mới mới nhất'
    },
    color: '#00d2d3',
    tenantId: 'default'
  },
  {
    ...
    slug: 'content',
    description: {
      en: 'Content creation and management',
      vi: 'Tạo và quản lý nội dung'
    },
    color: '#ff9f43',
    tenantId: 'default'
  },
  {
    ...
    slug: 'social-media',
    description: {
      en: 'Social media and networking',
      vi: 'Mạng xã hội và kết nối'
    },
    color: '#4834d4',
    tenantId: 'default'
  },
  {
    ...
    slug: 'web',
    description: {
      en: 'Web development and technologies',
      vi: 'Phát triển web và công nghệ'
    },
    color: '#6c5ce7',
    tenantId: 'default'
  },
  {
    ...
    slug: 'real-time',
    description: {
      en: 'Real-time applications and features',
      vi: 'Ứng dụng và tính năng real-time'
    },
    color: '#fd79a8',
    tenantId: 'default'
  },
  {
    ...
    slug: 'principles',
    description: {
      en: 'Design and development principles',
      vi: 'Nguyên tắc thiết kế và phát triển'
    },
    color: '#00b894',
    tenantId: 'default'
  }
...
const sampleSkills = [
  { name: { en: 'HTML/CSS', vi: 'HTML/CSS' }, level: { en: 'Advanced', vi: 'Nâng cao' }, icon: 'fab fa-html5', stars: 5, isActive: true },
  { name: { en: 'JavaScript', vi: 'JavaScript' }, level: { en: 'Advanced', vi: 'Nâng cao' }, icon: 'fab fa-js', stars: 5, isActive: true },
  { name: { en: 'React', vi: 'React' }, level: { en: 'Intermediate', vi: 'Trung bình' }, icon: 'fab fa-react', stars: 4, isActive: true },
  { name: { en: 'Node.js', vi: 'Node.js' }, level: { en: 'Intermediate', vi: 'Trung bình' }, icon: 'fab fa-node-js', stars: 4, isActive: true },
  { name: { en: 'TypeScript', vi: 'TypeScript' }, level: { en: 'Intermediate', vi: 'Trung bình' }, icon: 'fab fa-js', stars: 4, isActive: true },
  { name: { en: 'MongoDB', vi: 'MongoDB' }, level: { en: 'Basic', vi: 'Cơ bản' }, icon: 'fas fa-database', stars: 3, isActive: true }
];

const sampleLanguages = [
  { name: { en: 'English', vi: 'Tiếng Anh' }, level: { en: 'Fluent', vi: 'Thành thạo' }, icon: 'flag-icon-gb', stars: 5, isActive: true },
  { name: { en: 'Vietnamese', vi: 'Tiếng Việt' }, level: { en: 'Native', vi: 'Bản ngữ' }, icon: 'flag-icon-vn', stars: 5, isActive: true },
  { name: { en: 'Japanese', vi: 'Tiếng Nhật' }, level: { en: 'Basic', vi: 'Cơ bản' }, icon: 'flag-icon-jp', stars: 2, isActive: true }
];
...
async function seedDatabase() {
  try {
    ...
    await SkillModel.insertMany(sampleSkills);
    // Languages
    await LanguageModel.deleteMany({});
    await LanguageModel.insertMany(sampleLanguages);
    // Experience
    await ExperienceModel.deleteMany({});
    await ExperienceModel.insertMany(sampleExperience);
    // Education
    await EducationModel.deleteMany({});
    await EducationModel.insertMany(sampleEducation);
    ...
    await ThemeModel.insertMany(sampleThemes);
    ...
    await CertificateModel.insertMany(sampleCertificates);

    // Seed tags
    console.log('🏷️ Seeding tags...');
    await TagModel.insertMany(sampleTags);

    // Seed all site settings
    console.log('⚙️ Seeding all site settings...');
    await SiteSettingModel.insertMany(allSettingsSeed);
    ...
    console.log(`- Site Settings: ${allSettingsSeed.length} total settings`);
